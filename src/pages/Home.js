      ...
      <Layout style={{ minHeight: "100vh" }}>
        <Layout className="site-layout">
          <Content className="site-layout-content" style={{background:"linear-gradient(to bottom, #8BDFC7 20%, #458986 60%, #3c7875 80%, #346765 100%)"}}>
            ...
            <div style={{zIndex:"1", marginTop:"-20%"}}><img src={forest}/></div>
            ...
            <div id="container" style={{ overflow: "hidden !important", position: "relative", backgroundColor: "#FFC7C7" }} data-aos="fade-up" data-aos-duration="1000">
              <div class="product-details">
                ...
                <p style={{ fontSize: "3rem", marginBottom: "0em", fontFamily: "Montserrat, sans-serif", fontWeight: "600" }}>How ELEM Works</p>
