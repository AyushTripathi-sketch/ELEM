      ...
      <Layout style={{ marginTop: "7%" }}>
        <Layout style={{ padding: "0" }}>
          ...
          >
            ...
            <a href="/elemoney" class="carddash education">
              <div class="overlay"></div>
              <div class="circle">
                <img src={Elemoney} style={{width:"80%", zIndex:"4"}} alt=""/>
              ...
              <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: "1.2rem", textAlign: "center", fontWeight: "700"}}>ELEMONEY</p>
            </a>
            ...
            <a href="/myhousehold" class="carddash credentialing">
              ...
              <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: "1.2rem", textAlign: "center", fontWeight: "700"}}>HOUSEHOLD</p>
            </a>
            ...
            <a href="/dspn" class="carddash wallet">
              <div class="overlay"></div>
              <div class="circle">
              <img src={Elemart} style={{width:"80%", zIndex:"4", float:"left"}} alt=""/>
              ...
              <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: "1.2rem", textAlign: "center", fontWeight: "700"}}>ELEMART</p>
            </a>
            ...
            <a href="/welem" class="carddash human-resources">
              <div class="overlay"></div>
              <div class="circle">
              <img src={Welem} style={{width:"70%", zIndex:"4", float:"left"}} alt=""/>
              ...
              <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: "1.2rem", textAlign: "center", fontWeight: "700"}}>WELEM</p>
            </a>

            <a href="/monitoringsetup" class="carddash human-resources1">
              <div class="overlay"></div>
              <div class="circle">
              ...
              <p style={{ fontFamily: "Montserrat, sans-serif", fontSize: "1.2rem", textAlign: "center", fontWeight: "700"}}>MONITORING SETUP</p>
            </a>
